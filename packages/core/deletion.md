...
See [ADR 0001](../../docs/adr/0001-share-deletion-rules-across-platforms.md) for the decision and invariants. Canonical terms are defined in the [glossary](../../docs/reference/glossary.md). Related foundations: [Foundations](ARCHITECTURE.md). Operator steps: [Delete an account or asset](../../docs/howto/delete-account-or-asset.md).
