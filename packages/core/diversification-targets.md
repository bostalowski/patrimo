...
Decision: [ADR 0012](../../docs/adr/0012-allocation-coherence.md).
...
- Top1 / HHI ([ADR 0006](../../docs/adr/0006-portfolio-risk-readability.md)).

## See also

- [ADR 0012](../../docs/adr/0012-allocation-coherence.md)
- [Implement diversification targets](../../docs/howto/implement-diversification-targets.md)
- [Geographic allocation](geographic-allocation.md)
- [Excel workbook — Cibles diversification](../../docs/reference/excel-workbook.md)
- [API — diversification-targets](../../docs/reference/api-routes.md)
