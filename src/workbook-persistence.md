...
- A failed price-cache cleanup after a successful workbook write does not roll back the workbook (see [Deletion pipeline](../packages/core/deletion.md)).

## See also

- [Foundations](../packages/core/ARCHITECTURE.md)
- [Configure the Excel source](../docs/howto/configure-excel-source.md)
