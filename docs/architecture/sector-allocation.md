...
How Patrimo stores look-through sector weights and aggregates them. Decision: [ADR 0013](../adr/0013-sector-allocation.md).
...
- [ADR 0013](../adr/0013-sector-allocation.md)
