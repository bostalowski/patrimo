...
Transactions, assets, accounts, budget lines, properties, DCA plans, and manual prices live in a `.xlsx` workbook. Local JSON and AsyncStorage automatic price files are derived caches, not authoritative portfolio state.
