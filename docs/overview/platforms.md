...
| Real estate | Present — CRUD + analytics (ADR 0026) | Partial — read-only; projection KPIs from `@patrimo/core` (ADR 0026) |
| Fiscalité | Present — realized + foncier | Partial — realized only |
| Fees | Present | Partial |
| Projection | Present — immobilier shares core with mobile (ADR 0026) | Partial — immobilier via core; envelope overflow deferred |
...
| Savings capacity | Present — Dashboard + soft warnings on Investissements / DCA / Projection | Present — Dashboard card only |
