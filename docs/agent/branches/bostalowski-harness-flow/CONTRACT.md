...
| 5 | `role-worktree.sh` (Checker in isolated plain `git worktree`, no IDE/tool preference — renamed and simplified 2026-09-05, was `orca-role.sh`) + patrimo-harness skill update | E7, E8, N10 | L1 + L2 (script smoke) | `33387c4`, amended `<pending>` |
