...
| Docs handoff | Branch PROGRESS (+ run log) updated; glossary/ARCHITECTURE if needed; FEATURES matrix on merge; Tier B cadrage lock / teach-back recorded when Layer 2 applied | Branch PROGRESS only | Stale PROGRESS | No handoff |
