...
| 2026-09-06 | screen-on-test | Meaningful gate slugs + UI screenshots in PR descriptions | scripts/branch-ready.sh scripts/flow-status.sh scripts/pr-check.sh .agents/rules/meaningful-step-names.md .agents/skills/patrimo-harness/SKILL.md .claude/rules/meaningful-step-names.md .cursor/rules/harness.mdc .cursor/rules/meaningful-step-names.mdc .github/pull_request_template.md AGENTS.md CONSTRAINTS.md docs/DOC_MODEL.md | no |
