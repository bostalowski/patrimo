...
| 2026-09-05 | bostalowski-rework-log-auto-detect | Rework-log auto-detect (Touched + overlap gate) | .agents/skills/patrimo-harness/SKILL.md AGENTS.md Makefile docs/adr/0026-feature-flow-cadrage-to-merge.md docs/agent/rework-log.md docs/howto/feature-flow.md docs/howto/pr-checklist.md scripts/lib/rework-log.mjs scripts/pr-check.sh | n/a — not a rework — follow-up on feat-harness-checker-agent-isolation |
| 2026-09-06 | feat-harness-checker-agent-isolation | Checker agent isolation (subagent / fresh session) | scripts/role-worktree.sh .agents/skills/patrimo-harness/SKILL.md .gitignore AGENTS.md CONSTRAINTS.md FEATURES.md docs/adr/0026-feature-flow-cadrage-to-merge.md docs/adr/0030-checker-agent-isolation.md docs/adr/index.md docs/agent/scoring-rubric.md docs/howto/agent-loop.md docs/howto/feature-flow.md | n/a — not a rework — follow-up on screen-on-test |
| 2026-09-06 | bostalowski-coast-icu-hydration-note | Document Coast Alpine/small-icu hydration quirk | .agents/skills/coasts/SKILL.md Coastfile | no |
| 2026-09-06 | bostalowski-test-with-data | Seed sample workbook data for local dev | data-fixtures/sample-portfolio.xlsx docs/howto/local-dev-setup.md package.json scripts/ensure-dev-data.mjs | n/a — not a rework — follow-up on screen-on-test |
| 2026-09-06 | screen-on-test | Meaningful gate slugs + UI screenshots in PR descriptions | scripts/branch-ready.sh scripts/flow-status.sh scripts/pr-check.sh .agents/rules/meaningful-step-names.md .agents/skills/patrimo-harness/SKILL.md .claude/rules/meaningful-step-names.md .cursor/rules/harness.mdc .cursor/rules/meaningful-step-names.mdc .github/pull_request_template.md AGENTS.md CONSTRAINTS.md docs/DOC_MODEL.md | n/a — not a rework — follow-up on feat-realestate-loan-insurance-modes |
| 2026-09-05 | feat-realestate-loan-insurance-modes | Real-estate borrower insurance modes & schedule | mobile/app/index.tsx mobile/app/investissements.tsx mobile/app/projection.tsx mobile/lib/excel-mobile.ts packages/core/src/index.ts packages/core/src/property-taxes.ts packages/core/src/realestate/insurance.ts packages/core/src/realestate/loan.ts packages/core/src/realestate/projection.ts packages/core/src/realestate/property.ts packages/core/src/realestate/tax.ts packages/core/src/schema.ts | no |
