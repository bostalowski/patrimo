...
Governed by [ADR 0004](../docs/adr/0004-show-non-monthly-streams-on-mobile-projection.md). Projection math stays in `@patrimo/core`; mobile only formats and renders.
...
- [ADR 0004](../docs/adr/0004-show-non-monthly-streams-on-mobile-projection.md)
- [Implement mobile projection extra contributions](../docs/howto/implement-mobile-projection-extra-contributions.md)
