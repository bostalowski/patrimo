...
import { fetchJustEtfProfileHtml } from "./justetf-geography";
...
export async function syncJustEtfGeographicAllocationInSource(
  assetId: string,
  ...
  const unchanged =
    JSON.stringify(result.workbook.geographicAllocations ?? []) ===
